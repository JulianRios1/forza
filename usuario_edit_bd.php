...
if(isset($tipo_documento))
{
  ...
  if(!empty($_FILES['foto']['name'])){
    ...
    $carpetaAdjunta="assets/avatars/img/";
  ...
  { 
    ...
    { 
      ...
      if($enviar_email == 1)
      {
        ...
        $subject = utf8_decode("Ahora cuentas con toda la información de los productos de LHA");
                                                            ...
                                                            <tr>
                                                                <td valign="top" class="bodyContent">
                                                                    <div mc:edit="std_content00">
                                                                        ...
                                                                        <p>Gracias <b>'.$nom.' '.$ape1.' '.$ape2.'</b> por preferirnos.   </p>
