    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                <div class="portlet-title">
                                    ...
                                    <div class="actions">
                                        <button type="button" class="btn btn-transparent grey-salsa btn-circle btn-sm nueva"><i class="icon-plus"></i> Nuevo Contacto</button>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    <div class="table-container">
                                        <table class="table table-striped table-bordered table-hover" id="tabla_contactos">
                                            <thead>
                                                <tr>
                                                    <th> Descripción </th>
                                                    <th></th>
                    ...
                    <div id="customerModal" class="modal fade">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="#" id="form_contactos" class="horizontal-form" enctype="" autocomplete="off">
        ...
        jQuery(document).ready(function(){
            ...
            var oTable = table.dataTable({
                ...
                "ajax": {
                    "url": "ajax_paginas/ajax_contactos.php",
                    "type": "POST"
                },                  
                "columns": [
                    { "data": "contacto" },
                ...
                if(action != '') //This condition will check both variable has some value
                {
                    ...
                    form.validate({
                        ...
                        submitHandler: function (form) {
                            ...
                            var formData = new FormData(document.getElementById("form_contactos"));
                            formData.append("dato", "valor");
                            

                            $.ajax({
                                url: "ajax_paginas/contactos_modal_bd.php",
                                type: "post",
                                dataType: "html",
                                data: formData,
                                cache: false,
                                ...
                                success: function(data){
                                    ...
                                    $('#tabla_contactos').DataTable().ajax.reload();
            ...
            $(document).on('click', '.eliminar', function(){
                ...
                alertify.confirm("Seguro desea eliminar el contacto?", function (asc) {
                    if (asc) {
