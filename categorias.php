    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h3 class="page-title"> Categorías
                    </h3>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                <div class="portlet-title">
                                    ...
                                    <div class="actions">
                                        <button type="button" class="btn btn-transparent grey-salsa btn-circle btn-sm nueva"><i class="icon-plus"></i> Nueva Categoría</button>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    <div class="table-container">
                                        <table class="table table-striped table-bordered table-hover" id="tabla_categorias">
                                            <thead>
                                                <tr>
                                                    <th> Categoría </th>
                                                    <th> Línea</th>
        ...
        jQuery(document).ready(function(){
            ...
            var oTable = table.dataTable({
                ...
                "ajax": {
                    "url": "ajax_paginas/ajax_categorias.php",
                    "type": "POST"
                },                  
                "columns": [
                    { "data": "categoria" },
           ...
           /* $("#mi-boton").click(function() {
                ...
                if(action != '') //This condition will check both variable has some value
                {
                    ...
                    form.validate({
                        ...
                        submitHandler: function (form) {
                            ...
                            $.ajax({
                                url: "ajax_paginas/categorias_modal_bd.php",
                                type: "post",
                                dataType: "html",
                                data: formData,
                                cache: false,
            ...
            $(document).on('click', '.eliminar', function(){
                ...
                alertify.confirm("Seguro desea eliminar la categoría?", function (asc) {
                    if (asc) {
