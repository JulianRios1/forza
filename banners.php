    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                <div class="portlet-title">
                                    ...
                                    <div class="actions">                                                                                                        
                                        <a href="banner_add.php" class="btn btn-transparent grey-salsa btn-circle btn-sm "><i class="icon-plus"></i> Crear Banner </a> 
                                    </div>
                                </div>
        ...
        jQuery(document).ready(function(){
            ...
            var oTable = table.dataTable({
                ...
                "ajax": {
                    "url": "ajax_paginas/ajax_banners.php",
                    "type": "POST"
                },                  
                "columns": [
                    { "data": "nombre" },
            ...
            $('#banners > li > a.tool-action').on('click', function() {
            ...
            $(document).on('click', '.eliminar', function(){
                ...
                alertify.confirm("Seguro desea eliminar el banner?", function (asc) {
                    if (asc) {

                        $.ajax({
                            url:"banner_delete_bd.php",   
                            method:"POST",  
                            data:{id:id},
                            dataType:"html",   
