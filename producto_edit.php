...
$resultado = $mysqli->query("SELECT * FROM productos p WHERE idproducto = $id");
                                                ...
                                                <div class="tab-pane active" id="tab1">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input type="text" class="form-control" name="nombre" placeholder="" value="<?php  echo $row['desproducto'] ?>"> </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        Eliminar </a>
                                                                        <input type="hidden" name="hdd_foto" value="<?php echo $row['rutproducto'];?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-md-10">
                                                                <select class="table-group-action-input form-control input-medium" name="laboratorio">
                                                                    ...
                                                                    while ($row_mm = mysqli_fetch_array($resultado_mm)) {
                                                                        ?>
                                                                        <option value="<?php echo $row_mm['id']; ?>" <?php if($row['laboratorio'] == $row_mm['id']){ echo 'selected';} ?>><?php echo $row_mm["nomlaboratorio"]?></option>
                                                                        <?php
                                                                    }
                                                                    ?>
                                                                </select>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <select class="table-group-action-input form-control input-medium" name="categoria">
                                                                    ...
                                                                    while ($row_mm = mysqli_fetch_array($resultado_mm)) {
                                                                        ?>
                                                                        <option value="<?php echo $row_mm['idcategoria']; ?>" <?php if($row['categoria_idcategoria'] == $row_mm['idcategoria']){ echo 'selected';} ?>><?php echo $row_mm["descategoria"]?></option>
                                                                        <?php
                                                                    }
                                                                    ?>
                                                                </select>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <select class="table-group-action-input form-control input-medium" name="linea">
                                                                    ...
                                                                    for ($i=1; $i <=2 ; $i++) { 
                                                                        ?>
                                                                        <option value="<?php echo $i ?>" <?php if($row['linea'] == $i){ echo 'selected';} ?>><?php echo lineas($i) ?></option>
                                                                        <?php
                                                                    }
                                                                    ?>
                                                                </select>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label">Precio Lista 1:
                                                                <span class="required"> * </span>
                                                            </label>
                                                            <div class="col-md-10">
                                                                <input type="text" class="form-control" name="precio" placeholder="" onchange="puntillos(this);" onkeyup="puntillos(this);" value="<?php echo number_format($row['valproducto'],0,',','.') ?>"> </div>
                                                        </div>
                                                        <?php  
                                                        for ($i=2; $i <=8 ; $i++) { 
                                                        ?>
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label">Precio Lista <?php echo $i ?>: </label>
                                                            <div class="col-md-10">
                                                                <input type="text" class="form-control" name="precio<?php echo $i?>" placeholder="" onchange="puntillos(this);" onkeyup="puntillos(this);" value="<?php echo number_format($row['valproducto'.$i],0,',','.') ?>"> </div>
                                                        </div>
                                                        <?php } ?>
                                                        <!--
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <div class="icheck-inline">
                                                                    <label class="">
                                                                        <div class="icheckbox_minimal-grey" style="position: relative;"><input type="checkbox" name="promocion" id="promocion" class="icheck" style="position: absolute; opacity: 0;" value="1" <?php if($row['promocion'] == 1){ echo "checked";} ?>><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div>  </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input type="text" class="form-control" name="precio_promo" placeholder="" onchange="puntillos(this);" onkeyup="puntillos(this);" value="<?php echo number_format($row['valproducto'.$i],0,',','.') ?>"> </div>
                                                        </div>
                                                        -->
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <div class="icheck-inline">
                                                                    <label class="">
                                                                        <div class="icheckbox_minimal-grey" style="position: relative;"><input type="checkbox" name="agotado" id="agotado" class="icheck" style="position: absolute; opacity: 0;" value="1" <?php if($row['agotado'] == 1){ echo "checked";} ?>><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div>  </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <div class="icheck-inline">
                                                                    <label class="">
                                                                        <div class="icheckbox_minimal-grey" style="position: relative;"><input type="checkbox" name="inactivo" id="inactivo" class="icheck" style="position: absolute; opacity: 0;" value="1" <?php if($row['oculto'] == 1){ echo "checked";} ?>><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div>  </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <div class="icheck-inline">
                                                                    <label class="">
                                                                        <div class="icheckbox_minimal-grey" style="position: relative;"><input type="checkbox" name="destacado" id="destacado" class="icheck" style="position: absolute; opacity: 0;" value="1" <?php if($row['destacado'] == 1){ echo "checked";} ?>><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div>  </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input type="text" class="form-control" name="meta" placeholder="" value="<?php  echo $row['meta_producto'] ?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                    <div class="input-group input-large">
                                                                        ...
                                                                        <input type="hidden" name="hdd_archivo" value="<?php echo $row['archivo'];?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                ...
                                                                <?php 
                                                                $array_recomendados = explode(";", $row['recomendados']);

                                                                $resultado_mm = $mysqli->query("SELECT idproducto, desproducto, formafarmaceutica FROM productos WHERE idproducto != $id ORDER BY desproducto");
                                                                while ($row_mm = mysqli_fetch_array($resultado_mm)) {
                                                                    ?>
                                                                    <option value="<?php echo $row_mm['idproducto']; ?>" <?php if (in_array($row_mm['idproducto'], $array_recomendados, true)) { echo 'selected';} ?>><?php echo $row_mm["desproducto"].'('.$row_mm["formafarmaceutica"].')'?></option>
                                                                    <?php
                                                                }
                                                                ?>
                                                                </select>
                                                ...
                                                <div class="tab-pane" id="tab2">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <textarea class="form-control maxlength-handler" rows="8" name="des_tab2"><?php echo $row['descripcion1'] ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tab-pane" id="tab3">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label">Descripción:</label>
                                                            <div class="col-md-10">
                                                                <textarea class="form-control maxlength-handler" rows="8" name="des_tab3"><?php echo $row['descripcion2'] ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tab-pane" id="tab4">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label">Descripción:</label>
                                                            <div class="col-md-10">
                                                                <textarea class="form-control maxlength-handler" rows="8" name="des_tab4"><?php echo $row['descripcion3'] ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tab-pane" id="tab5">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label">Descripción:</label>
                                                            <div class="col-md-10">
                                                                <textarea class="form-control maxlength-handler" rows="8" name="des_tab5"><?php echo $row['descripcion4'] ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tab-pane" id="tab6">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label">Descripción:</label>
                                                            <div class="col-md-10">
                                                                <textarea class="form-control maxlength-handler" rows="8" name="des_tab6"><?php echo $row['descripcion5'] ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tab-pane" id="tab7">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label">Descripción:</label>
                                                            <div class="col-md-10">
                                                                <textarea class="form-control maxlength-handler" rows="8" name="des_tab7"><?php echo $row['descripcion6'] ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tab-pane" id="tab8">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label">Descripción:</label>
                                                            <div class="col-md-10">
                                                                <textarea class="form-control maxlength-handler" rows="8" name="des_tab8"><?php echo $row['descripcion7'] ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tab-pane" id="tab9">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label">Descripción:</label>
                                                            <div class="col-md-10">
                                                                <textarea class="form-control maxlength-handler" rows="8" name="des_tab9"><?php echo $row['descripcion8'] ?></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tab-pane" id="tab10">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input type="text" class="form-control" name="title" placeholder="" value="<?php echo $row['title'] ?>"> </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-md-2 control-label">Description:</label>
                                                            <div class="col-md-10">
                                                                <input type="text" class="form-control" name="description" placeholder="" value="<?php echo $row['description'] ?>"> </div>
                                                        </div>
                                                        <?php 
                                                        for ($i=1; $i<=6 ; $i++) { 
                                                            ?>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-10">
                                                                    <input type="text" class="form-control" name="h<?php echo $i?>" placeholder="" value="<?php echo $row['h'.$i] ?>"> </div>
                                                            </div>
                                                            <?php
                                                        }
                                                        ?>
