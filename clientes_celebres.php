                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="#">Clientes Celebres</a>
                            </li>
                        </ul>
                    </div>


                    <h3 class="page-title"> Clientes Celebres</h3>
                                                    ...
                                                    <div class="form-body">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="span_small" class="control-label">Trimestre</label>
                                                                    <select id="trimestre" name="trimestre" class="form-control input-md">
                                                                        <option value="">-Seleccione-</option>
                                                                        <?php
                                                                        for($i=1; $i<=4; $i++)
                                                                        {
            ...
            jQuery(document).ready(function() {
                ...
                form.validate({
                    ...
                    submitHandler: function (form) {
                        ...
                        $.ajax({
                            url: "ajax_paginas/ajax_cliente_celebre.php",
                            type: "post",
                            dataType: "html",
                            data: formData,
                            cache: false,
                ...
                $(document).on('click', '#enviar_datos', function(){
                    ...
                    $("#valor_boton").val($(this).attr("value"));

                    var formData2 = new FormData(document.getElementById("form_cliente_celebre"));
                    formData2.append("dato", "valor");

                    $.ajax({
                        url: "ajax_paginas/ajax_cliente_celebre_add_bd.php",
                        type: "post",
                        dataType: "html",
                        data: formData2,
                        cache: false,
