                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="#">Informe de Clientes Celebre</a>
                            </li>
                        </ul>
                    </div>


                    <h3 class="page-title"> Informe de Clientes Celebre</h3>
            ...
            jQuery(document).ready(function() {
                ...
                form.validate({
                    ...
                    submitHandler: function (form) {
                        ...
                        $.ajax({
                            url: "ajax_paginas/ajax_info_cliente_celebres.php",
                            type: "post",
                            dataType: "html",
                            data: formData,
                            cache: false,
