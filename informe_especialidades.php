                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="#">Informe de Especialidades</a>
                            </li>
                        </ul>
                    </div>


                    <h3 class="page-title">Informe de Especialidades</h3>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label for="span_small" class="control-label">Especialidad</label>
                                                                    <select id="especialidad" name="especialidad" class="form-control input-md">
                                                                        <option value="">-Seleccione-</option>
                                                                        <?php
                                                                        $resultado= $mysqli->query("SELECT * FROM especialidades ORDER BY descripcion");
                                                                        while ($row = mysqli_fetch_array($resultado))
                                                                        {
                                                                            ?>
                                                                            <option value="<?php echo $row['id'].';'.$row['descripcion']?>"><?php echo $row['descripcion']?></option>
                                                                            <?php
                                                                        }
                                                                        ?>                                                                  
                                                                    </select>
            ...
            jQuery(document).ready(function() {
                ...
                form.validate({
                    ...
                    submitHandler: function (form) {
                        ...
                        $.ajax({
                            url: "ajax_paginas/ajax_info_especialidades.php",
                            type: "post",
                            dataType: "html",
                            data: formData,
                            cache: false,
