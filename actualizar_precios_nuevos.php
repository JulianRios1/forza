                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="#">Cargar Listado de Precios</a>
                            </li>
                        </ul>
                    </div>

                    <h3 class="page-title"> Cargar Listado de Precios</h3>
            ...
            jQuery(document).ready(function() {
                ...
                form.validate({
                    ...
                    submitHandler: function (form) {
                       ...
                       $.ajax({
                            url: "actualizar_precios_nuevos_bd.php",
                            type: "post",
                            dataType: "html",
                            data: formData,
                            cache: false,
                        ...
                        .done(function(res){
                            alertify.alert(res, function(ev) {
                                location.href='actualizar_precios_nuevos.php';
                            });
                        });
                        return false;
                    }
