...
$resultado = $mysqli->query("SELECT * FROM laboratorios");
...
while($row = mysqli_fetch_array($resultado)){		
	...
	$editar = '<a href=\"laboratorio_edit.php?id='.$row['id'].'\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Editar\" class=\"btn btn-primary btn-xs\"><i class=\"fa fa-edit\"></i></a>';
	...
	$tabla.='{
		"descripcion":"'.$row['nomlaboratorio'].'",
		"editar":"'.$editar.'",
		"eliminar":"'.$eliminar.'"
	},';	
}	
