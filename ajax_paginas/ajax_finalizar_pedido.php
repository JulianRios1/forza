...
if ($num_reg > 0)
{
    ...
    $insertar = "INSERT INTO `pedidos` (`usuario_idusuario`, `estadopedido`, `iva`, `total`, `descuento`, `fecpedido`, `observacion`, `usuarioRegistra`, `session_id`) VALUES ($id, 2, 0, $total, 0, CURRENT_TIMESTAMP(), '$obs', '" . $_SESSION["idusuario"] . "', '" . $session_id . "')";
...
$destino_adicional = "";
$correo_vendedor = "";
if (strlen($destino_pedido) > 0)
{ //si el parámetro de destino de pedido está desactivado
