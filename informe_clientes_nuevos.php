                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="#">Informe de Clientes Nuevos</a>
                            </li>
                        </ul>
                    </div>


                    <h3 class="page-title"> Clientes Nuevos</h3>
            ...
            jQuery(document).ready(function() {
                ...
                form.validate({
                    ...
                    submitHandler: function (form) {
                        ...
                        $.ajax({
                            url: "ajax_paginas/ajax_cliente_nuevos.php",
                            type: "post",
                            dataType: "html",
                            data: formData,
                            cache: false,
                ...
                $(document).on('click', '.validar', function(){
                    ...
                    $("input[name='chkOrder_"+id+"']").prop("disabled", true);

                    $.ajax({
                        url:"validar_medico.php",   
                        method:"POST",  
                        data:{id:id},
                        dataType:"html",   
                        ...
                        success:function(data){
                            //console.log(data);
                            //$('#tabla_clientes_new').children().DataTable().ajax.reload();
