                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="#">Informe Clientes Preferenciales</a>
                            </li>
                        </ul>
                    </div>


                    <h3 class="page-title"> Informe clientes descuento preferencial</h3>
            ...
            jQuery(document).ready(function() {
                ...
                form.validate({
                    ...
                    submitHandler: function (form) {
                        ...
                        $.ajax({
                            url: "ajax_paginas/ajax_info_cli_pref.php",
                            type: "post",
                            dataType: "html",
                            data: formData,
                            cache: false,
