        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <?php
                    $resultado = $mysqli->query("SELECT * FROM banners WHERE id = $id"); 
                    $row = mysqli_fetch_array($resultado);
                    ?>
                    <h3 class="page-title"> Editar Banner
                    </h3>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="nom" placeholder="" class="form-control" value="<?php echo $row['nombre'] ?>" style="text-transform:uppercase" />     
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                        ...
                                                                        {
                                                                            ?>
                                                                            <img src="../naturcom/img/banners/<?php echo $row['imagen'];?>" alt=""/>
                                                                            <?php
                                                                        }
                                                                        else
                                                                        {
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            Eliminar </a>
                                                                            <input type="hidden" name="hdd_foto" value="<?php echo $row['imagen'];?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="link" placeholder="" class="form-control" value="<?php echo $row['link'] ?>"  />     
                                                                    </div>
                                                                </div>
                                                            </div>
