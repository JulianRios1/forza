...
?>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="#">Literaturas</a>
                            </li>
                        </ul>
                    </div>

                    <h3 class="page-title"> Literaturas
                    </h3>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                <div class="portlet-title">
                                    ...
                                    <div class="actions">
                                        <button type="button" class="btn btn-transparent grey-salsa btn-circle btn-sm nueva"><i class="icon-plus"></i> Nueva Literatura</button>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    <div class="table-container">
                                        <table class="table table-striped table-bordered table-hover" id="tabla_literaturas">
                                            <thead>
                                                <tr>
                                                    <th> Descripción </th>
                                                    <th> Estado </th>
                    ...
                    <div id="customerModal" class="modal fade">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="#" id="form_literaturas" class="horizontal-form" enctype="" autocomplete="off">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="estado" class="form-control" id="estado">
                                                ...
                                                <option value="0"> <?php echo estado(0) ?></option>
                                                <option value="1"> <?php echo estado(1) ?></option>  
                                            </select>
        ...
        jQuery(document).ready(function(){
            ...
            var table = $('#tabla_literaturas');     
            var oTable = table.dataTable({

                "bDeferRender": true,           

                "ajax": {
                    "url": "ajax_paginas/ajax_literaturas.php",
                    "type": "POST"
                },                  
                "columns": [
                    { "data": "especialidad" },
                ...
                if(action != '') //This condition will check both variable has some value
                {
                    ...
                    form.validate({
                        ...
                        submitHandler: function (form) {
                            ...
                            var formData = new FormData(document.getElementById("form_literaturas"));
                            formData.append("dato", "valor");
                            

                            $.ajax({
                                url: "ajax_paginas/literatura_modal_bd.php",
                                type: "post",
                                dataType: "html",
                                data: formData,
                                cache: false,
                                ...
                                success: function(data){
                                    ...
                                    $('#tabla_literaturas').DataTable().ajax.reload();
                ...
                //alert(action);
                    $.ajax({
                        ...
                        success:function(data){
                            ...
                            $('.modal-title').text("Editar Literatura");
            ...
            $(document).on('click', '.nueva', function(){
                $('#customerModal').modal('show'); 
                $('.modal-title').text("Nueva Literatura");
                $('#action').val("Guardar");
                $('#des').val('');
                $('#estado').val('');
            ...
            $(document).on('click', '.eliminar', function(){
                ...
                alertify.confirm("Seguro desea eliminar la literatura?", function (asc) {
                    if (asc) {
