...
?>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                <div class="portlet-title">
                                    ...
                                    <div class="actions">
                                        <button type="button" class="btn btn-transparent grey-salsa btn-circle btn-sm nueva"><i class="icon-plus"></i> Nuevo Obsequio</button>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    <div class="table-container">
                                        <table class="table table-striped table-bordered table-hover" id="tabla_obsequios">
                                            <thead>
                                                <tr>
                                                    <th> Descripción </th>
                                                    <th> Estado </th>
                    ...
                    <div id="customerModal" class="modal fade">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="#" id="form_obsequios" class="horizontal-form" enctype="" autocomplete="off">
        ...
        jQuery(document).ready(function(){
            ...
            var table = $('#tabla_obsequios');     
            var oTable = table.dataTable({

                "bDeferRender": true,           

                "ajax": {
                    "url": "ajax_paginas/ajax_obsequios.php",
                    "type": "POST"
                },                  
                "columns": [
                    { "data": "obsequio" },
                ...
                if(action != '') //This condition will check both variable has some value
                {
                    ...
                    form.validate({
                        ...
                        submitHandler: function (form) {
                            ...
                            var formData = new FormData(document.getElementById("form_obsequios"));
                            formData.append("dato", "valor");
                            

                            $.ajax({
                                url: "ajax_paginas/obsequios_modal_bd.php",
                                type: "post",
                                dataType: "html",
                                data: formData,
                                cache: false,
                                ...
                                success: function(data){
                                    ...
                                    $('#tabla_obsequios').DataTable().ajax.reload();
                ...
                //alert(action);
                    $.ajax({
                        ...
                        success:function(data){
                            ...
                            $('.modal-title').text("Editar Obsequio");
            ...
            $(document).on('click', '.nueva', function(){
                $('#customerModal').modal('show'); 
                $('.modal-title').text("Nuevo Obsequio");
                $('#action').val("Guardar");
                $('#des').val('');
                $('#estado').val('');
            });
            ...
            $(document).on('click', '.eliminar', function(){
                ...
                alertify.confirm("Seguro desea eliminar el obsequio?", function (asc) {
                    if (asc) {
