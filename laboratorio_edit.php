        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <?php
                    $resultado = $mysqli->query("SELECT * FROM laboratorios WHERE id = $id"); 
                    $row = mysqli_fetch_array($resultado);
                    ?>
                    <h3 class="page-title"> Editar Laboratorio
                    </h3>
                                                    ...
                                                    <form action="#" id="form_datos_basicos" class="horizontal-form" enctype="multipart/form-data" autocomplete="off">
                                                        <div class="form-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="nom" placeholder="" class="form-control" value="<?php echo $row['nomlaboratorio'] ?>" style="text-transform:uppercase" />     
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                        ...
                                                                        {
                                                                            ?>
                                                                            <img src="assets/logos/<?php echo $row['imagen'];?>" alt=""/>
                                                                            <?php
                                                                        }
                                                                        else
                                                                        {
                                                            ...
                                                            <div class="margiv-top-10 form-actions">
                                                                ...
                                                                <a href="laboratorios.php" class="btn default"> Regresar </a>
