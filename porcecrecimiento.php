                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="#">% de crecimiento</a>
                            </li>
                        </ul>
                    </div>


                    <h3 class="page-title"> Tabla % de crecimiento</h3>
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select id="zona" name="zona" class="form-control input-md">
                                                                            ...
                                                                            $resultado= $mysqli->query("SELECT * FROM zonas  ORDER BY des");
            ...
            jQuery(document).ready(function() {
                ...
                form.validate({
                    ...
                    submitHandler: function (form) {
                        ...
                        $.ajax({
                            url: "ajax_paginas/ajax_porcentaje_crecimiento.php",
                            type: "post",
                            dataType: "html",
                            data: formData,
                            cache: false,
                ...
                $(document).on('click', '#button', function(){
                    ...
                    var formData2 = new FormData(document.getElementById("form_porcentajes"));
                    formData2.append("dato", "valor");


                    $.ajax({
                        url: "ajax_paginas/ajax_porcentaje_crecimiento_bd.php",
                        type: "post",
                        dataType: "html",
                        data: formData2,
                        cache: false,
