        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h3 class="page-title"> Editar Rol
                    </h3>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="portlet light ">
                                            ...
                                            <?php 
                                            $resultado = $mysqli->query("SELECT * FROM roles WHERE id = ".$id); 
                                            $row0 = mysqli_fetch_array($resultado)
                                            ?>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">Nombre Rol</label>
                                                    <input type="text" name="nomrol" placeholder="" class="form-control" value="<?php echo $row0['nomrol'] ?>" /> 
                                                </div>
                                            </div>
                                            <div class="form-group form-md-checkboxes">
                                                ...
                                                while($row = mysqli_fetch_array($resultado))
                                                {
                                                    ...
                                                    //echo "SELECT * FROM permisos_roles WHERE rol_id = ".$id;
                                                    $resultado_rol = $mysqli->query("SELECT * FROM permisos_roles WHERE rol_id = ".$id); 

/*resultado2 = "SELECT * FROM permiso_rol WHERE rol_idrol = ".$id;
                                                    $resultado_rol = mysql_query($consulta, $conexion);
                                                    $num_reg = mysql_num_rows($resultado_rol);*/

                                                    $funciones_rol = array();

                                                    while($row2 = mysqli_fetch_array($resultado_rol))
                                                    {
                                                        array_push($funciones_rol, $row2["permiso_id"]);
                                                    } 
                                                ?> 
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="md-checkbox">
                                                                <input type="checkbox" id="<?php echo $j ?>" name="chk_permisos[]" value="<?php echo $row3["id"]?>" class="md-check" <?php if (in_array($row3["id"], $funciones_rol)) { echo "checked"; } ?>>
